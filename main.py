# multiple choice quiz dictionary for preparatory grade
prep_dict = {'A thirty-second note triplet is equal in duration to a:': ['Quarter note', 'Half note', 'Eighth note', 'Sixteenth note'],
             ...
             'The Sol-La interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             'The Do#-Re interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             'The Fa-Sol# interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             'The Re-Mi# interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             'The Si#-Do interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             ...
             'The Re-Re# interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             'The Do-Re# interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             'The Mi#-Fa interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
             ...
             'The La#-Si♭ interval is equal to a:': ['Tone', 'Semitone', 'Trisemitone', 'Enharmonic equivalent'],
...
# multiple choice quiz dictionary for 1st grade
...
# multiple choice quiz dictionary for 2nd grade
...
# multiple choice quiz dictionary for 3rd grade
third_dict = {'Which of the following intervals is dissonant?': ['Do-Re', 'Fa#-Do#', 'Fa-La', 'Mi-Do'],
              ...
              'What kind of chord is Re#-Fa#-La?': ['Major', 'Minor', 'Augmented', 'Diminished'],
              'A diminished chord belongs to:': ['3 major (I-IV-V) and 2 minor (V-VI) scales', '3 major (II-III-VI) and 2 minor (I-IV) scales', '1 major (VII) and 2 minor (II-VII) scales', '1 minor scale (III)'],
              'The degrees of a minor scale that have a major chord are:': ['II-III-IV', 'I-IV-V', 'V-VI', 'I-IV']
              }
...
third_df = pd.read_csv('third_grade.csv')
...
def generate_question(grade):
    ...
    if grade == '0':
        ...
        # locate the correct answer to the question in the first dataframe
        correct_answer = second_df.Answer[second_df.Question == question].iloc[0]
        # remove the questions-answers pair from the dictionary
        ...
        # select randomly a pair of question-possible answers from the second_dict
        question, answer = random.choice(list(third_dict.items()))
        # locate the correct answer to the question in the first dataframe
        correct_answer = third_df.Answer[third_df.Question == question].iloc[0]
        # remove the questions-answers pair from the dictionary
